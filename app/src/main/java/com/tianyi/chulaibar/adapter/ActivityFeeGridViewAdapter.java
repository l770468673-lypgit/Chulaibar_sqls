 ...
 */
public class ActivityFeeGridViewAdapter extends BaseAdapter {
    ...
    public ActivityFeeGridViewAdapter(Context context, String[] data){
                ...
                viewHolder.textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(now!=position) {
                            ...
                            //保存当前点击的fee
                            fee=mData[now];
                            edit.putString("fee",fee);   //根据键值对添加数据
                            edit.commit();	//保存数据信息
